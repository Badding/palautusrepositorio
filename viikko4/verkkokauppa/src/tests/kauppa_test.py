...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paatyttya_pankin_metodia_tilimaksu_kutsutaan_parametreilla(self):
    ...
    def test_kahden_tuotteen_osto_pankin_metodia_kutsutaan_parametreilla(self):
    ...
    def test_kahden_saman_tuotteen_osto_pankin_metodia_kutsutaan_parametreilla(self):
    ...
    def test_kahden_tuotteen_osto_vain_toinen_varastossa(self):
    ...
    def test_korista_tuote_pois_poistaa_tuotteen(self):
